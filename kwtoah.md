...
<table align="center">
	...
	<tr>
	  <td valign="top"><?php echo 'Total Amp hours per day</td>
	...
	<tr>
	  <td valign="top"><input type="button" value="<?php echo 'Calculate" onclick="docalc()" /></td>
	  <td valign="top"><input type="reset"  value="<?php echo 'Reset" onclick="clearForm()" />	</td>
	</tr>
